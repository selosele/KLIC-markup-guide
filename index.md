...
- [3. CSS 코드 작성 규칙](#3-css-코드-작성-규칙)
  ...
  - [3.11. !important 속성 사용 지양](#311-important-속성-사용-지양)
  - [3.12. 특정 class 사용 지양](#312-특정-class-사용-지양)
- [참고 사이트](#참고-사이트)
...
개발 적용과 관련된 주석은 다음과 같이 **해당하는 요소 바로 위에 표기**하며, [D]라는 말머리를 사용하여 담당 개발자가 반드시 확인할 수 있도록 한다. 종료 주석은 표기하지 않는다.
...
<head>
    ...
    <meta property="og:image" content="/images/web/main/layout/logo.png"> <!-- 사이트 로고 이미지 경로 -->
...
이 방식으로 처리가 안 되는 예외적인 상황에만 해당 class를 사용하고, 사용 시 충분한 설명을 주석에 표기하여 다른 작업자가 파악하는 데 문제 없도록 한다.
