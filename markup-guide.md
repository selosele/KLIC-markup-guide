...
* [개요](#user-content-개요)
* [문서 버전 및 이력](#user-content-문서-버전-및-이력)
* [1. 공통 규칙](#user-content-1-공통-규칙)
    ...
    * [1.4. 파일명](#user-content-14-파일명)
        * [1.4.1. HTML/CSS/JS 파일명](#user-content-141-htmlcssjs-파일명)
        * [1.4.2. 이미지 파일명](#user-content-142-이미지-파일명)
    * [1.5. 들여쓰기](#user-content-15-들여쓰기)
* [2. HTML 코드 작성 규칙](#user-content-2-html-코드-작성-규칙)
    ...
    * [2.3. ID값 선언](#user-content-23-id값-선언)
* [3. CSS 코드 작성 규칙](#user-content-3-css-코드-작성-규칙)
    * [3.1. 주석 표기](#user-content-31-주석-표기)
        * [3.1.1. 특정 요소 그룹핑을 위한 주석 표기](#user-content-311-특정-요소-그룹핑을-위한-주석-표기)
    * [3.2. 의미 있는 요소들 간의 공백](#user-content-32-의미-있는-요소들-간의-공백)
    * [3.3. 중괄호/콜론/세미콜론 간의 공백](#user-content-33-중괄호콜론세미콜론-간의-공백)
    * [3.4. 줄바꿈](#user-content-34-줄바꿈)
...
* [4. Javascript 코드 작성 규칙](#user-content-4-javascript-코드-작성-규칙)
    ...
    * [4.3. 줄바꿈](#user-content-43-줄바꿈)
    * [4.4. 파라미터(매개변수)](#user-content-44-파라미터매개변수)
...
#### 1.4.1. HTML/CSS/JS 파일명

#### 1.4.2. 이미지 파일명

이미지 파일명은 **img뎁스명_번호** 표기법을 따른다. 아래는 sub0101.html 파일에 들어가는 두 장의 이미지에 대한 네이밍을 예시로 들어보았다.
